...
public enum EnemyType {
    ...
    SineWave(Assets.spaceShipAssets.get(6), 15f, 100f, 100f, 2f, 3, 3f, 1f, 60f, 0, 2.5f, 1 / 3f, 50f, 0f, 30f), // enemy moving in sine wave pattern
    Rammer(Assets.spaceShipAssets.get(7), 15f, 50f, 10000f, 10000f, 1, 3f, 1f, 60f, 0, 2.5f, 1 / 3f, 50f, 0f, 30f), // enemy moving in sine wave pattern
    MoneyDrop(Assets.spaceShipAssets.get(8), 15f, 500f, 200f, 5f, 0, 3f, 1f, 90f, 0, 2.5f, 1 / 3f, 50f, 0f, 60f), // enemy drops money
    Boss(Assets.spaceShipAssets.get(9), 25f, 3000f, 3000f, 300f, 0, 3f, 1f, 70f, 3, 3f, 1 / 4f, 70f, 5f, 40f), // boss dummy
    MiniBoss1(Assets.spaceShipAssets.get(12), 20f, 500f, 1000f, 100f, 2, 3f, 1f, 80f, 2, 3f, 1 / 4f, 60f, 5f, 50f); // miniboss1
